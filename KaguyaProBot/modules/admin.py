...
from KaguyaProBot import DRAGONS, dispatcher
...
from KaguyaProBot.modules.helper_funcs.admin_rights import user_can_changeinfo, user_can_promote
from KaguyaProBot.modules.helper_funcs.extraction import (
    extract_user,
    extract_user_and_text,
)
from KaguyaProBot.modules.log_channel import loggable
from KaguyaProBot.modules.helper_funcs.alternate import send_message
    ...
    if msg.reply_to_message:
        ...
        try:
            with open("gpic.png", "rb") as chatp:
                ...
                msg.reply_text("Successfully set new chatpic! Hurray!!!")
        except BadRequest as excp:
            msg.reply_text(f"Error! {excp.message}")
        finally:
            dlmsg.delete()
...
def set_desc(update: Update, context: CallbackContext):
    ...
    if len(tesc) >= 2:
        ...
        return msg.reply_text("You know, setting empty description won't do anything!")
    try:
        if len(desc) > 255:
            return msg.reply_text("Don't overdo it, description must needs to be under 255 characters!")
...
def fullpromote(update: Update, context: CallbackContext) -> str:
    ...
    if (
        ...
        message.reply_text("You don't have the necessary rights to do that Nigga!")
        return
