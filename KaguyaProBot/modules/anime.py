...
from KaguyaProBot.modules.helper_funcs.extraction import extract_user, extract_user_and_text
from KaguyaProBot.modules.helper_funcs.string_handling import extract_time
from KaguyaProBot import DEV_USERS, OWNER_ID, DRAGONS, dispatcher, REQUEST_CHAT_ID
...
def awake(update: Update, context: CallbackContext):
    message = update.effective_message
    IMAGE = "https://telegra.ph/file/0e2064896320536b65aae.jpg"
    msg = ""
    msg += f"{AWAKE_MSG}"
    support = "t.me/ShinomiyaSupport"
    updates = "t.me/ShinomiyaUpdates"
    buttons = [
	[
...
def request(update: Update, context: CallbackContext):
    ...
    to_send = to_send.replace("@KaguyaProBot","")
