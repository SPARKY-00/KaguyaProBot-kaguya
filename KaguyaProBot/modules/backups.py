...
import KaguyaProBot.modules.sql.notes_sql as sql
from KaguyaProBot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from KaguyaProBot.__main__ import DATA_IMPORT
from KaguyaProBot.modules.helper_funcs.chat_status import user_admin
from KaguyaProBot.modules.helper_funcs.alternate import typing_action

# from KaguyaBot.modules.rules import get_rules
import KaguyaProBot.modules.sql.rules_sql as rulessql

# from KaguyaBot.modules.sql import warns_sql as warnssql
import KaguyaProBot.modules.sql.blacklist_sql as blacklistsql
from KaguyaProBot.modules.sql import disable_sql as disabledsql

# from KaguyaBot.modules.sql import cust_filters_sql as filtersql
# import KaguyaBot.modules.sql.welcome_sql as welcsql
import KaguyaProBot.modules.sql.locks_sql as locksql
from KaguyaProBot.modules.connection import connected
...
def export_data(update, context):
    ...
    context.bot.sendDocument(
        ...
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `KaguyaBot-Backup` was specially made for notes.".format(
            chat.title,
            chat_id,
            tgl,
        ),
    ...
    os.remove("KaguyaBot{}.backup".format(chat_id))  # Cleaning file
