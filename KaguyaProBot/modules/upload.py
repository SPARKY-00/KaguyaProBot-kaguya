...
from KaguyaProBot import telethn as bot
from KaguyaProBot.modules.urluploader import download_file
from KaguyaProBot.utils.uputils import humanbytes, progress
    ...
    if event.reply_to_msg_id:
        ...
        try:
            ...
            await bot.send_file(
                ...
                dosya,
                force_document=True,
                caption=f"Uploaded By *Kaguya (Kaguya)*",
            )
        except Exception as e:
            traceback.print_exc()
