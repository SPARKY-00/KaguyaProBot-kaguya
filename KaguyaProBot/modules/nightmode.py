import os
from KaguyaProBot.modules.sql.night_mode_sql import (
    add_nightmode,
    rmnightmode,
    get_all_chat_id,
    is_nightmode_indb,
...
from KaguyaProBot import telethn as tbot, OWNER_ID
...
@register(pattern="^/(nightmode|Nightmode|NightMode|Oyasumimode|oyasumimode) ?(.*)")
