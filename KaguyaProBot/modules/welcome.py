...
import KaguyaProBot.modules.sql.welcome_sql as sql
...
from KaguyaProBot.modules.helper_funcs.misc import build_keyboard, revert_buttons
from KaguyaProBot.modules.helper_funcs.msg_types import get_welcome_type
        ...
        if should_welc:
            ...
            if new_mem.id == OWNER_ID:
                update.effective_message.reply_text(
                    f"The First Wizard King just joined in {html.escape(chat.title)}!!!.",
                    reply_to_message_id=reply,
                )
                welcome_log = (
    ...
    if should_goodbye:
        ...
        if left_mem:
            ...
            if left_mem.id == OWNER_ID:
                update.effective_message.reply_text(
                    "Prince Lemiel left the chat. Sayonara Master. ;(",
                    reply_to_message_id=reply,
                )
                return
...
def welcome(update: Update, context: CallbackContext):
    ...
    if not args or args[0].lower() == "noformat":
        ...
        if args[0].lower() in ("on", "yes"):
            ...
            update.effective_message.reply_text("Okay!!! I won't welcome anyone..")
