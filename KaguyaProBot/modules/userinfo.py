...
from KaguyaProBot.__main__ import STATS, TOKEN, USER_INFO, get_readable_time
from KaguyaProBot.modules.sql import SESSION
import KaguyaProBot.modules.sql.userinfo_sql as sql
from KaguyaProBot.modules.disable import DisableAbleCommandHandler
from KaguyaProBot.modules.sql.global_bans_sql import is_user_gbanned
from KaguyaProBot.modules.sql.afk_sql import is_afk, set_afk, check_afk_status
from KaguyaProBot.modules.sql.users_sql import get_user_num_chats
from KaguyaProBot.modules.helper_funcs.chat_status import sudo_plus
from KaguyaProBot.modules.helper_funcs.extraction import extract_user
from KaguyaProBot import telethn
...
def info(update: Update, context: CallbackContext):
    ...
    if disaster_level_present:
        text += ' [<a href="https://t.me/ShinomiyaUpdates/4">✮</a>]'.format(
            bot.username,
        )
                    ...
                    [
                        [
                            InlineKeyboardButton(
                                "Health", url="https://t.me/ShinomiyaUpdates/5"),
                            InlineKeyboardButton(
...
def stats(update, context):
    ...
    try:
        update.effective_message.reply_text(
            ...
            + "╘══ 『 by [Nαɾυƚσ](https://t.me/Husbandoo) 』\n",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
        )
...
*What is that health thingy?*
 Come and see [HP System explained](https://t.me/ShinomiyaUpdates/5)
"""
