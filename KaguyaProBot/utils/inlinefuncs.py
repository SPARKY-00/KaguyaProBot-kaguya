...
from KaguyaProBot import arq
from KaguyaProBot.services.keyboard import Ikb
from KaguyaProBot.utils.pluginhelper import convert_seconds_to_minutes as time_convert, fetch
from KaguyaProBot.services.tasks import _get_tasks_text, all_tasks, rm_task
from KaguyaProBot.services.types import InlineQueryResultCachedDocument
from KaguyaProBot.modules.info import get_chat_info, get_user_info
from KaguyaProBot.modules.music import download_youtube_audio
from KaguyaProBot.utils.functions import test_speedtest
from KaguyaProBot.utils.pastebin import paste
...
async def alive_function(answers):
    ...
    msg = f"""
**[Kaguya Robot ❤️](https://t.me/ShinomiyaSupport):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [UBOT](t.me/Husbandoo)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
            description="Check Bot's Stats",
            thumb_url="https://telegra.ph/file/2023d7c4a27551deaf8fa.jpg",
            input_message_content=InputTextMessageContent(
