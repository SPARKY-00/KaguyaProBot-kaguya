...
import KaguyaProBot.modules.sql.users_sql as sql
from KaguyaProBot.modules.helper_funcs.extraction import (
    extract_user,
    extract_user_and_text,
)
from KaguyaProBot import pbot as app
...
from KaguyaProBot.modules import ALL_MODULES
from KaguyaProBot.modules.helper_funcs.chat_status import is_user_admin
from KaguyaProBot.modules.helper_funcs.misc import paginate_modules
...
➢ Try The Help Buttons Below To See The Commands Available After My Element Buff ✿[.](https://telegra.ph/file/a53d70bd26de174b8f1a2.mp4) 
"""


HELP_STRINGS = """
Hey there, I'm Kaguya Robot !
...
FLARE_PHOTO = "https://telegra.ph/file/0e2064896320536b65aae.jpg"

DONATE_STRING = """Thanks For Your Support Though My Creator Doesn't Need Support Monetarily, Still Contact Him For More Info:- @Husbandoo """
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("KaguyaProBot.modules." + module_name)
...
def Kaguya_about_callback(update, context):
    ...
    if query.data == "Kaguya_":
        query.message.edit_text(
            text="๏ I'm *Kaguya (Kaguya)*, a powerful group management bot built to help you manage your group easily."
            ...
            "\n\n_Kaguya's licensed under the GNU General Public License v3.0_"
            "\n\n Click on button bellow to get basic help for Kaguya Bot.",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
        ...
        query.message.edit_text(
            ...
            "\nCongragulations, Kaguya (Kaguya) is now ready to manage your group."
            "\n\n*Admin Tools*"
    ...
    elif query.data == "ShinomiyaSupport":
        query.message.edit_text(
            text="**๏ Kaguya Support Chats**"
            "\nJoin My Support Group/Channel for see or report a problem on Kaguya.",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
